...
public class AudioMngHelper {
    ...
    private int NOW_AUDIO_TYPE =AudioManager.STREAM_SYSTEM;//TYPE_MUSIC;
    private int NOW_FLAG = FLAG_SHOW_UI;//FLAG_NOTHING;
    ...
    public int addVoice100() {
        ...
        //audioManager.setStreamVolume(AudioManager.STREAM_MUSIC, a, AudioManager.FLAG_SHOW_UI);
