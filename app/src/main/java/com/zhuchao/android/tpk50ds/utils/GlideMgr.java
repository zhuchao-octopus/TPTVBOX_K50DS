...
public class GlideMgr {
    ...
    public static RequestOptions addGlideOptions = new RequestOptions()
            .centerCrop().error(R.drawable.pulldown_add).placeholder(R.drawable.pulldown_add);

    public static RequestOptions normalGlideOptions = new RequestOptions()
            .centerCrop();
