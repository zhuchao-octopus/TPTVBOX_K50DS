package com.zhuchao.android.tpk50ds.bridge;
...
public class BaseEffectBridgeWrapper extends BaseEffectBridge {
	...
	public void flyWhiteBorder(final View focusView, View moveView, float scaleX, float scaleY) {
		...
		Log.e("tag","newX="+newX+"    newY="+newY+"   newWidth="+newWidth+"   newHeight="+newHeight+"     oldWidth="+oldWidth+"    oldHeight="+oldHeight);
		...
		ObjectAnimator scaleYAnimator = ObjectAnimator.ofInt(new ScaleView(moveView), "height", oldHeight,
				(int) newHeight);
		//
		Log.e("tag","transAnimatorX="+transAnimatorX+"    transAnimatorY="+transAnimatorY+"    scaleXAnimator="+scaleXAnimator+"    scaleYAnimator="+scaleYAnimator);
