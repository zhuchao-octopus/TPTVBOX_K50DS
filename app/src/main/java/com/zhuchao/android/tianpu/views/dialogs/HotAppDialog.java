    ...
    private void handleClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.remove:
                ...
                //Intent intent = new Intent("com.zhuchao.android.tianpu.views.dialogs.CLEAR_ACTION");
                //intent.setData(Uri.parse("package:www"));
                //intent.putExtra("vId", rId);
                //context.sendBroadcast(intent);
                //((MainActivity) context).binding.ivAdd1.setImageResource(R.drawable.add);
                //((MainActivity) context).binding.ivAdd1.setTag("");
                break;
        }
        dismiss();
    }
